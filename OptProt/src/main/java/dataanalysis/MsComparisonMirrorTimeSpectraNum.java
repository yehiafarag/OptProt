 ...
 * @author yfa041
 */
public class MsComparisonMirrorTimeSpectraNum {
    ...
    public MsComparisonMirrorTimeSpectraNum(String updatedTitle, String dataFolder, Map<String, ArrayList<Double>> bottomChartDataTypeValueMap, Map<String, ArrayList<Double>> topChartDataTypeValueMap, String SE,int figNumber) {
...
//        combinedTopChart.draw(g2, r1);
//       
        g2.translate(229, 589);// three item174
//        g2.translate(31, 86);
        legend.paint(g2);
...
//        domainAxis.setLabelPaint(Color.BLUE);
        ...
        NumberAxis xAxis1 = new NumberAxis("# Spectra") {
            boolean dirty = true;
            AxisState as;
...
//        renderer.setMaximumBarWidth(0.9);
        ...
        renderer.setBaseItemLabelFont(DataAnalysisHandler.Default_Font); // Set label font
...
//        xAxis1.setTickMarkInsideLength(5.0f);
        ...
        CategoryAxis domainAxis = new CategoryAxis() {
            ...
            protected TextBlock createLabel(Comparable category, float width, RectangleEdge edge, Graphics2D g2) {
                ...
                tb1.addLine(new TextLine(catAsString.split("\n")[1], DataAnalysisHandler.Default_Font, green));
                return tb1;
            }
        };
        domainAxis.setTickLabelFont(DataAnalysisHandler.Default_Font);
...
//        chart.getLegend().setMargin(margin.getTop(),300,margin.getBottom(),margin.getRight());
    ...
    private JPanel createLegend() {
        ...
        container.setSize(new Dimension(192, 30));//312, 30 (3 items
...
//        iconII.setLocation(124, 9);
        ...
        JLabel itemII = new JLabel("Full Data");
//        itemII.setLocation(141, 5);
        itemII.setLocation(27, 5);
        itemII.setSize(53, 20);
        container.add(itemII);

        JPanel iconI = new JPanel();
        iconI.setSize(12, 12);
        iconI.setBackground(new Color(124, 185, 232));
        iconI.setLocation(90, 9);
        container.add(iconI);

        JLabel itemI = new JLabel("Filtered Data");
        itemI.setLocation(107, 5);
        itemI.setSize(75, 20);
        container.add(itemI);
...
//        container.add(itemIII);
    ...
    public static void compareSubMsPerformance(String parentDataFolderURL) {
        try {
            Map<String, ArrayList<Double>> sageDsFullMSSizeMap = new LinkedHashMap<>();
            sageDsFullMSSizeMap.put("Filtered-MS-File", new ArrayList<>());
            sageDsFullMSSizeMap.put("Sub-MS-File", new ArrayList<>());
            Map<String, ArrayList<Double>> xtandDsFullMSSizeMap = new LinkedHashMap<>();

            xtandDsFullMSSizeMap.put("Filtered-MS-File", new ArrayList<>());
            xtandDsFullMSSizeMap.put("Sub-MS-File", new ArrayList<>());

            Map<String, ArrayList<Double>> sageDsFullMSTimeMap = new LinkedHashMap<>();

            sageDsFullMSTimeMap.put("Filtered-MS-File", new ArrayList<>());
            sageDsFullMSTimeMap.put("Sub-MS-File", new ArrayList<>());
            sageDsFullMSTimeMap.put("Similarty", new ArrayList<>());

            Map<String, ArrayList<Double>> xtandDsFullMSTimeMap = new LinkedHashMap<>();

            xtandDsFullMSTimeMap.put("Filtered-MS-File", new ArrayList<>());
            xtandDsFullMSTimeMap.put("Sub-MS-File", new ArrayList<>());
            xtandDsFullMSTimeMap.put("Similarty", new ArrayList<>());
            File timeValueFile = new File(parentDataFolderURL, "FilteredMsSubMs.txt");
            try (Scanner myReader = new Scanner(timeValueFile)) {
                ...
                while (myReader.hasNextLine()) {
                    ...
                    if (xtand) {
                        ...
                        xtandDsFullMSTimeMap.get("Sub-MS-File").add(Double.valueOf(values[0]));
                        xtandDsFullMSTimeMap.get("Filtered-MS-File").add(Double.valueOf(values[1]));
                        xtandDsFullMSTimeMap.get("Similarty").add(Double.valueOf(values[2]));
                        xtandDsFullMSSizeMap.get("Sub-MS-File").add(Double.valueOf(values[3]));
                        xtandDsFullMSSizeMap.get("Filtered-MS-File").add(Double.valueOf(values[4]));
                    } else {
                        sageDsFullMSTimeMap.get("Sub-MS-File").add(Double.valueOf(values[0]));
                        sageDsFullMSTimeMap.get("Filtered-MS-File").add(Double.valueOf(values[1]));
                        sageDsFullMSTimeMap.get("Similarty").add(Double.valueOf(values[2]));

                        sageDsFullMSSizeMap.get("Sub-MS-File").add(Double.valueOf(values[3]));
                        sageDsFullMSSizeMap.get("Filtered-MS-File").add(Double.valueOf(values[4]));
                    }
                }
            }
            MsComparisonMirrorTimeSpectraNum XtandFastaComparisonMirrorChart = new MsComparisonMirrorTimeSpectraNum("MS size based search", parentDataFolderURL, xtandDsFullMSTimeMap, xtandDsFullMSSizeMap, Advocate.xtandem.getName(),6);
            MsComparisonMirrorTimeSpectraNum SageFastaComparisonMirrorChart = new MsComparisonMirrorTimeSpectraNum("MS size based search", parentDataFolderURL, sageDsFullMSTimeMap, sageDsFullMSSizeMap, Advocate.sage.getName(),7);
    ...
    public static void main(String[] args) {
        compareSubMsPerformance("D:\\Manuscripts\\manuscript 2024\\SearchTagsResults\\sub-ds");
    }
